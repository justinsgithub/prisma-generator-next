...
const Home: NextPage = () => {
  const d =  { data: { title: 'testing from postman', content: 'this is content created from postman', published: true, likes: BigInt(20), }, }
  console.log(serialize(d))
  useEffect(() => {
    try {
      
    axios
        .post('/api/pgen/posts', d, {transformRequest: serialize})
      .then((res) => {
